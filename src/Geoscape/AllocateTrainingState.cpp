 ...
 */
AllocateTrainingState::AllocateTrainingState(Game *game, Base *base) : State(game)
{
	_base = base;
	// Create objects
	...
	_lstSoldiers->onMousePress((ActionHandler)&AllocateTrainingState::lstSoldiersPress);
	_lstSoldiers->onMouseClick((ActionHandler)&AllocateTrainingState::lstSoldiersClick);
	_lstSoldiers->onMouseRelease((ActionHandler)&AllocateTrainingState::lstSoldiersRelease);
 ...
 */
void AllocateTrainingState::btnOkClick(Action *action)
{
	_game->popState();
	_game->pushState (new TrainingState(_game));
}

void AllocateTrainingState::lstSoldiersPress(Action *action)
{
}
void AllocateTrainingState::lstSoldiersRelease(Action *action)
{
}
void AllocateTrainingState::lstSoldiersClick(Action *action)
{
	...
	if (action->getDetails()->button.button == SDL_BUTTON_LEFT)
	{
		...
		{
			_base->getSoldiers()->at(_sel)->setTraining();
