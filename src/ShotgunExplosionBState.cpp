 ...
 */
ShotgunExplosionBState::ShotgunExplosionBState(BattlescapeGame *parent, Position center, BattleItem *item, BattleUnit *unit, Tile *tile) : BattleState(parent), _unit(unit), _center(center), _item(item), _tile(tile)
{
}
 ...
 */
ShotgunExplosionBState::~ShotgunExplosionBState()
{
 ...
 * - explosion sound
 */
void ShotgunExplosionBState::init()
{
 ...
 */
void ShotgunExplosionBState::think()
{
		...
		if(!(*i)->animate())
		{
			...
			if (_parent->getMap()->getExplosions()->empty())
			{
				...
				if (_item)
				{
					...
					if (_item->getRules()->getBattleType() != BT_MELEE && ((_item->getRules()->getDamageType() == DT_HE || _item->getRules()->getDamageType() == DT_SMOKE|| _item->getRules()->getDamageType() == DT_STUN)||(_item->getRules()->getDamageType() == DT_IN && !_item->getRules()->isFlamer())))
					{
 ...
 */
void ShotgunExplosionBState::cancel()
{
}
